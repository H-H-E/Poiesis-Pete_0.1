...
export default function Home() {
  ...
  const [messages, setMessages] = useState([
    { role: "assistant", content: "Welcome to Poiesis Education! I'm Poiesis Pete, a chatbot made to help you learn more about our educational services. Are you a student, parent or admin?" }
  ]);
    ...
    <>
      ...
      <div className={styles.topnav}>
        ...
        <div className={styles.navlinks}>
          <a href="https://platform.openai.com/docs/models/gpt-4" target="_blank">Website</a>
